...
file_path = '/Users/junior/Projects/slash/apps/desktop/src/features/settings/GeneralTab.tsx'
...
# Replace light mode #C8C8C8 text with #545454
content = re.sub(r'(?<!dark:)text-\[\#C8C8C8\]', r'text-[#545454]', content)
...
print("Replaced secondary text colors in GeneralTab.tsx")
